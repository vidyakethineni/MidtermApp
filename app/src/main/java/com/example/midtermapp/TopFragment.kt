...
import com.example.midtermapp.databinding.FragmentBottomBinding
import com.example.midtermapp.databinding.FragmentTopBinding
...
class TopFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val viewModel = ViewModelProvider(requireParentFragment())[GameViewModel::class.java]
        binding.viewModel = viewModel
        binding.lifecycleOwner = this
        viewModel.insertedSuccess.observe(viewLifecycleOwner){
            if(it == true) {
